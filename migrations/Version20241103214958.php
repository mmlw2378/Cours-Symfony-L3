 ...
 */
final class Version20241103214958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD client_id INT DEFAULT NULL, ADD roles JSON NOT NULL, ADD is_blocked TINYINT(1) NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE login login VARCHAR(180) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP client_id, DROP roles, DROP is_blocked, CHANGE login login VARCHAR(25) NOT NULL, CHANGE password password VARCHAR(15) NOT NULL, CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(100) NOT NULL');
    }
}
